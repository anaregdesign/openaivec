...
class TestPandasExt(unittest.TestCase):
    ...
    def test_embed(self):
        embeddings: pd.Series = self.df["name"].openaivec.embed("text-embedding-3-large")
    ...
    def test_predict(self):
        names_fr: pd.Series = self.df["name"].openaivec.predict("gpt-4o-mini", "translate to French")
